...
export const intents: Intent[] = [
  ...
  },
 {
  ...
  {
    id: 'typhoid',
    patterns: ['typhoid', 'typhoid fever', 'टाइफाइड', 'टाइफॉयड', 'typhoid symptoms', 'typhoid prevention'],
    responses: {
      en: 'Typhoid fever symptoms include sustained high fever (103–104°F), headache, stomach pain, loss of appetite, diarrhea or constipation, and a rose-colored rash on the trunk. Prevention: 1) Drink only safe, treated or boiled water 2) Eat freshly cooked hot food 3) Wash hands thoroughly before eating and after using toilet 4) Get the typhoid vaccine 5) Avoid raw fruits and vegetables that cannot be peeled 6) Use clean and covered toilets. See a doctor immediately if you have a high fever lasting more than 2–3 days.',
      hi: 'टाइफाइड बुखार के लक्षणों में लगातार तेज बुखार (103–104°F), सिरदर्द, पेट दर्द, भूख न लगना, दस्त या कब्ज, और पेट पर गुलाबी दाने शामिल हैं। बचाव: 1) केवल सुरक्षित, उपचारित या उबला हुआ पानी पिएं 2) ताजा पका हुआ गर्म खाना खाएं 3) खाने से पहले और शौचालय के बाद हाथ अच्छी तरह धोएं 4) टाइफाइड का टीका लगवाएं 5) बिना छीलने योग्य कच्चे फल-सब्जियां न खाएं 6) स्वच्छ और ढके शौचालय का उपयोग करें। यदि 2–3 दिनों से अधिक तेज बुखार हो तो तुरंत डॉक्टर से मिलें।',
      bn: 'টাইফয়েড জ্বরের লক্ষণগুলির মধ্যে রয়েছে ক্রমাগত উচ্চ জ্বর (103–104°F), মাথাব্যথা, পেটব্যথা, ক্ষুধামান্দ্য, ডায়রিয়া বা কোষ্ঠকাঠিন্য এবং পেটে গোলাপী দাগ। প্রতিরোধ: 1) শুধুমাত্র নিরাপদ, পরিশোধিত বা ফুটানো পানি পান করুন 2) টাটকা রান্না করা গরম খাবার খান 3) খাওয়ার আগে এবং টয়লেটের পরে ভালোভাবে হাত ধুন 4) টাইফয়েড টিকা নিন।',
      ta: 'டைஃபாய்டு காய்ச்சல் அறிகுறிகளில் தொடர்ந்து உயர் காய்ச்சல் (103–104°F), தலைவலி, வயிற்று வலி, பசியின்மை, வயிற்றுப்போக்கு அல்லது மலச்சிக்கல், மற்றும் உடலில் இளஞ்சிவப்பு தடிப்பு ஆகியவை அடங்கும். தடுப்பு: 1) பாதுகாப்பான, சுத்திகரிக்கப்பட்ட அல்லது கொதிக்கவைத்த நீரை மட்டுமே குடிக்கவும் 2) புதிதாக சமைத்த சூடான உணவை சாப்பிடுங்கள் 3) சாப்பிடுவதற்கு முன் கைகளை நன்றாக கழுவுங்கள் 4) டைஃபாய்டு தடுப்பூசி போட்டுக்கொள்ளுங்கள்.',
      te: 'టైఫాయిడ్ జ్వరం లక్షణాలలో నిరంతర ఎక్కువ జ్వరం (103–104°F), తలనొప్పి, పొట్ట నొప్పి, ఆకలి తగ్గడం, విరేచనాలు లేదా మలబద్ధకం, మరియు శరీరంపై గులాబీ రంగు దద్దుర్లు ఉంటాయి. నివారణ: 1) సురక్షితమైన, శుద్ధి చేయబడిన లేదా మరిగించిన నీరు మాత్రమే తాగండి 2) తాజాగా వండిన వేడి ఆహారం తినండి 3) తినడానికి ముందు మరియు మరుగుదొడ్డి తర్వాత చేతులు బాగా కడగండి 4) టైఫాయిడ్ టీకా వేయించుకోండి.',
    },
  },
  {
    id: 'greeting',
  ...
  },
  {
    ...
    patterns: [],
    responses: {
      en: 'I apologize, but I did not fully understand your question. I can help you with information about: dengue, malaria, diabetes, fever, cold and cough, typhoid, COVID-19, vaccination, and general health tips. Please ask about these topics or rephrase your question.',
      hi: 'मुझे खेद है, लेकिन मैं आपके प्रश्न को पूरी तरह से समझ नहीं पाया। मैं आपकी मदद कर सकता हूं: डेंगू, मलेरिया, मधुमेह, बुखार, सर्दी-खांसी, टाइफाइड, कोविड-19, टीकाकरण और सामान्य स्वास्थ्य युक्तियों के बारे में जानकारी के साथ। कृपया इन विषयों के बारे में पूछें या अपना प्रश्न दोबारा पूछें।',
      bn: 'আমি দুঃখিত, কিন্তু আমি আপনার প্রশ্নটি পুরোপুরি বুঝতে পারিনি। আমি আপনাকে সাহায্য করতে পারি: ডেঙ্গু, ম্যালেরিয়া, ডায়াবেটিস, জ্বর, সর্দি-কাশি, টাইফয়েড, কোভিড-19, টিকা এবং সাধারণ স্বাস্থ্য টিপস সম্পর্কে তথ্য দিয়ে।',
      ta: 'மன்னிக்கவும், ஆனால் உங்கள் கேள்வியை முழுமையாக புரிந்துகொள்ள முடியவில்லை. நான் உங்களுக்கு உதவ முடியும்: டெங்கு, மலேரியா, நீரிழிவு, காய்ச்சல், குளிர்-இருமல், டைஃபாய்டு, கோவிட்-19, தடுப்பூசி மற்றும் பொதுவான ஆரோக்கிய குறிப்புகள் பற்றிய தகவல்.',
      te: 'నేను క్షమాపణలు కోరుతున్నాను, కానీ నేను మీ ప్రశ్నను పూర్తిగా అర్థం చేసుకోలేకపోయాను. నేను మీకు సహాయం చేయగలను: డెంగ్యూ, మలేరియా, మధుమేహం, జ్వరం, జలుబు-దగ్గు, టైఫాయిడ్, కోవిడ్-19, టీకాలు మరియు సాధారణ ఆరోగ్య చిట్కాల గురించి సమాచారం.',
    },
  },
];
